...
//        }
       ...
       if(path.startsWith("/api/member/loginlocal")) return true;
       if(path.startsWith("/api/images/")) return true;
       if(path.startsWith("/api/uploads/")) return true;
       if(path.startsWith("/api/member/test")) return true;
       if(path.startsWith("/api/member/join")) return true;
       if(path.startsWith("/api/member/emailcheck")) return true;
       if(path.startsWith("/api/member/nincknamecheck")) return true;
       if(path.startsWith("/api/member/fileupload")) return true;
       if(path.startsWith("/api/member/kakaostart")) return true;
       if(path.startsWith("/api/member/kakaoLogin")) return true;
       if(path.startsWith("/api/favicon.ico")) return true;
