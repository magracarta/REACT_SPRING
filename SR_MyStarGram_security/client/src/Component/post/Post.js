            ...
            { <Slider {...settings} >
                {
                    (images)?(
                        images.map((img, idx)=>{
                            return (
                                <img key={idx} src={`http://52.78.197.165:8070/uploads/${img.savefilename}`} width="750" height="900"/>
                            )
                        })
                    ):(null)
                }
            ...
            <div className='like'>
                {
                    (likeList)?( 
                        ...
                        ?
                        ( <img src={`http://52.78.197.165:8070/images/delike.png`} onClick={ ()=>{ onLike() } } />)
                        :
                        (<img src={`http://52.78.197.165:8070/images/like.png`} onClick={ ()=>{ onLike() } }  />)
                    ):(
                        <img src={`http://52.78.197.165:8070/images/like.png`} onClick={ ()=>{ onLike() } }  />
                    )
                }
                ...
                &nbsp;&nbsp;
                <img src={`http://52.78.197.165:8070/images/reply.png`} onClick={()=>{
                    viewOrNot()
                }}/>
            </div>
            <div className='like'>
